...
Item {
    ...
    property alias spinBoxTo: objSpinBox.to
    property alias spinBoxFrom: objSpinBox.from
    property alias spinBoxValue: objSpinBox.value
    property alias spinBox: objSpinBox
